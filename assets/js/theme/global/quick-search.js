...
export default function (context) { // Chiara add context
    ...
    const doSearch = _.debounce((searchQuery) => {
        utils.api.search.search(searchQuery, { template: 'search/quick-results' }, (err, response) => {
            ...
            // Chiara
            if (context.themeSettings.card_show_swatches) {
                import('../../chiara/product-card-color-swatches').then(module => module.inViewCheck(null, $quickSearchResults.find('[data-lock-body-scroll]')));
            }
