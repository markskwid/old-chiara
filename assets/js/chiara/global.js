...
function initBrandsCarousel() {
    ...
    $carousel.each((id, el) => {
        ...
        if ($el.hasClass('chiara-testimonialsCarousel-slider')) {
          params.centerPadding = "0px";
          params.variableWidth = false;
        }
...
export default class ChiaraGlobal extends PageManager {
    onReady() {
        ...
        if (this.context.themeSettings.card_show_swatches) {
            import('./product-card-color-swatches').then(module => module.inViewCheck(this.context));
        }
